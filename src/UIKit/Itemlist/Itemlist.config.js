...
export const COMPONENT_NAME = 'Itemlist';
export const ITEMLIST_CLASS_NAME = 'eduk-itemlist';
export const IMAGE_CLASS_NAME = 'eduk-itemlist__img';
export const HEADER_CLASS_NAME = 'eduk-itemlist__header';
export const DESCRIPTION_CLASS_NAME = 'eduk-itemlist__description';
